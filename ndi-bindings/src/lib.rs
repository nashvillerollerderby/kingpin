...
impl<'a> Recv<'a> {
    ...
    pub fn capture(&mut self, timeout_ms: u32) -> Result<FrameType, Error> {
        ...
        /// TODO: Identify issue causing corruption 
        /// 
...
//     pub audio_frame: NDIlib_audio_frame_v3_t,
//     pub video_frame: NDIlib_video_frame_v2_t,
// }
//
// unsafe impl std::marker::Send for FrameSync {}
// unsafe impl std::marker::Sync for FrameSync {}
//
// impl FrameSync {
//     pub fn new(recv: &Recv) -> Self {
//         let instance = unsafe { NDIlib_framesync_create(recv.instance) };
//         FrameSync {
//             instance,
//             audio_frame: NDIlib_audio_frame_v3_t::default(),
//             video_frame: NDIlib_video_frame_v2_t::default(),
//         }
//     }
//
//     pub fn with_video_frame(mut self, video_frame: NDIlib_video_frame_v2_t) -> Self {
...
//                 self.instance,
//                 &mut self.audio_frame,
//                 sample_rate.unwrap_or(0).into(),
//                 no_channels.unwrap_or(0).into(),
//                 no_samples.unwrap_or(i32::MAX).into(),
//             )
//         }
//     }
//
...
//         unsafe {
//             NDIlib_framesync_free_audio_v2(self.instance, &mut self.audio_frame);
//         }
//     }
//
//     pub fn get_audio_frame(&self) -> AudioFrame {
//         AudioFrame::from_raw(self.audio_frame)
//     }
//
//     pub fn capture_video(&mut self, frame_format_type: FrameFormatType) {
//         unsafe {
//             NDIlib_framesync_capture_video(
//                 self.instance,
//                 &mut self.video_frame,
//                 frame_format_type.into(),
//             )
//         }
//     }
//
...
//         unsafe {
//             NDIlib_framesync_free_video(self.instance, &mut self.video_frame);
//         }
//     }
//
//     pub fn get_video_frame(&self) -> VideoFrame {
//         unsafe { VideoFrame::from_raw(&self.video_frame) }
//     }
// }
//
