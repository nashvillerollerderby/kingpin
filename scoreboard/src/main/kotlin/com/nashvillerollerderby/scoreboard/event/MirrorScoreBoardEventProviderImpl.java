...
public class MirrorScoreBoardEventProviderImpl<M extends ScoreBoardEventProvider, C
    ...
    protected <T> void setCopy(Value<T> prop) {
        setCopy(prop, sourceElement, prop, false);
    }
    ...
    protected <T extends ScoreBoardEventProvider> void addMirrorCopy(final Child<T> sourceProperty) {
        ...
        for (T element : sourceElement.getAll(sourceProperty)) {
            add(targetProperty, toMirror(element), Source.COPY);
        }
    }
    ...
    public static void addClassMapping(Class<? extends ScoreBoardEventProvider> source,
        ...
        if (elements.get(mirror) == null) {
            elements.put(mirror, new HashMap<>());
        }
    }

    private static final Map<Class<? extends ScoreBoardEventProvider>, Class<? extends MirrorScoreBoardEventProvider<?>>>
